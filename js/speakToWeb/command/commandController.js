define(
    ["command/commandRepo", "command/commandProcessor", "command/commandExecutor", "textKeeper/textKeeper",
        ...
        function CommandController(options) {
            ...
            var fuse = new Fuse(commandRepo.commandList, {
                keys: ["command", "aliases"],
                id: 'id',
                threshhold: 0.1
            });
